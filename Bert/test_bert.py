...
if __name__ == '__main__':
    ...
    # 加载模型状态字典
    checkpoint_path = 'model_checkpoint.pth'  # 使用与BERT.py相同的路径
    try:
    ...
    print(f"Input text: {input_text[:50]}...")  # 输出部分文本以避免过长
